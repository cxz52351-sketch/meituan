...
function App() {
  ...
  return (
    <div className="app">
      {isChatPage && <div style={{ height: 20 }} />}
      {!isDetailPage &&
        !isInsightsPage &&
        !isTuanziInsightsPage &&
        !isChatPage && (
            ...
            <div className="header-content">
              ...
              <div className="university-selector">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setSelectedUniversity(e.target.value as University | "all")
                  }
                >
      ...
      <main className="main-content">
        <Routes>
          <Route
            path="/"
            element={<HomePage university={selectedUniversity} />}
          />
          <Route
            path="/map"
            element={<MapPage university={selectedUniversity} />}
          />
          <Route
            path="/group"
            element={<GroupOrderPage university={selectedUniversity} />}
          />
          <Route
            path="/random"
            element={<RandomPage university={selectedUniversity} />}
          />
          <Route
            path="/ai"
            element={<ChatAgent university={selectedUniversity} />}
          />
          <Route
            path="/rank"
            element={<RankPage university={selectedUniversity} />}
          />
          <Route
            path="/rank/:rankId"
            element={<RankPage university={selectedUniversity} />}
          ...
          <Route
            path="/list"
            element={<ListPage university={selectedUniversity} />}
          />
          <Route path="/restaurant/:id" element={<DetailPage />} />
          <Route
            path="/profile"
            element={<ProfilePage university={selectedUniversity} />}
          />
